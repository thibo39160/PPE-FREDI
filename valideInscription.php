<?php
        ...
        try{
            ...
            $reqVerif = "select 'adresse-mail',nom,prenom from demandeurs WHERE 'adresse-mail'=?";
            ...
            $req = "INSERT into adherents (adresse-mail,nom,prenom,rue,cp,ville,num-recu,mdp,sexe) VALUES (?,?,?,?,?,?,?,?,?)";
            ...
            $qid->bindParam(7, $numrecu, PDO::PARAM_STR,20);
